  ...
  Widget build(BuildContext context) => GetBuilder<HomeController>(
        builder: (ctrl) {
          return RefreshIndicator(
            onRefresh: () async {
              ctrl.fetchfarmerListings(widget.username);
            },
            child: Scaffold(
              appBar: AppBar(
                            ...
                            itemBuilder: (context, index) {
                              return ListCard(
                                ...
                                name: ctrl.farmerlistingsShowInUi[index].name ??
                                    'No name',
                                hbidname: ctrl.farmerlistingsShowInUi[index].hbidname ?? '',
                                imageUrl:
                                    ctrl.farmerlistingsShowInUi[index].image ??
                                        'url',
                                amount:
                                    ctrl.farmerlistingsShowInUi[index].amount ??
                                        00,
                                hbid: ctrl.farmerlistingsShowInUi[index].hbid ??
                                    0,
