...
class EArticlesPage extends StatefulWidget {
  const EArticlesPage({super.key});

  @override
  State<EArticlesPage> createState() => _EArticlesPageState();
}

class _EArticlesPageState extends State<EArticlesPage> with TickerProviderStateMixin{
