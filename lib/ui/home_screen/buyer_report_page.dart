...
import '../report/buyer_reports_page.dart';
import '../report/farmer_reports_page.dart';
import '../report/statistics.dart';

class BuyerReportPage extends StatefulWidget {
  const BuyerReportPage({super.key});

  @override
  State<BuyerReportPage> createState() => _ReportPageState();
}

class _ReportPageState extends State<BuyerReportPage> {
                    ...
                    onTap: () {
                      ...
                      if (isPremium) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => BuyerReportsPage(),
                          ),
                        );
                      } else {
