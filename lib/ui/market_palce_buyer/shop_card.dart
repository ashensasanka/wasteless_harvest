...
class _ShopCardState extends State<ShopCard> {
  ...
  final userCollection = FirebaseFirestore.instance.collection("add_listing");
  ...
  Future<void> editField(String field) async {
    ...
    if (newValue.trim().isNotEmpty){
      await userCollection.doc("aXs5rNJTp88WjLCQVyKH").update({field: double.tryParse(newValue)});
    }
  }
