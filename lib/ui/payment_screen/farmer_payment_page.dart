...
class FPaymentPage extends StatefulWidget {
  final String userName;
  const FPaymentPage({super.key, required this.userName});

  @override
  State<FPaymentPage> createState() => _FPaymentPageState();
}

class _FPaymentPageState extends State<FPaymentPage> {
