...
import 'farmer_root_page.dart';


class SignInFarmer extends StatefulWidget {
  const SignInFarmer({Key? key}) : super(key: key);
...
class _SignInFarmerState extends State<SignInFarmer> {
  TextEditingController signfarmerusernameController = TextEditingController();
  TextEditingController signfarmerpasswordController = TextEditingController();
          ...
          child: Column(
            ...
            children: [
              ...
              textFeld(
                ...
                maxLines: 1,
                controller: signfarmerusernameController,
              ),
              TextField(
                controller: signfarmerpasswordController,
              ...
              GestureDetector(
                onTap: () async {
                  try {
                    ...
                    var snapshot = await FirebaseFirestore.instance.collection('farmer_users').doc(signfarmerusernameController.text).get();
                    ...
                    if (snapshot.exists) {
                      ...
                      if (signfarmerusernameController.text == username &&
                          signfarmerpasswordController.text == password) {
