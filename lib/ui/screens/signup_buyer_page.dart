...
class SignUpBuyer extends StatefulWidget {
  SignUpBuyer({Key? key}) : super(key: key);
...
class _SignUpState extends State<SignUpBuyer> {
  ...
  TextEditingController buyerusernameController = TextEditingController();
  TextEditingController buyerpasswordController = TextEditingController();
  TextEditingController buyercpasswordController = TextEditingController();
  ...
  void dispose() {
    super.dispose();
    buyerusernameController.dispose();
    buyerpasswordController.dispose();
    buyercpasswordController.dispose();
  ...
  Widget build(BuildContext context) {
    ...
    buyerphoneController.selection = TextSelection.fromPosition(
        TextPosition(offset: buyerphoneController.text.length)
    );
    final isLoading =
          ...
          child: Column(
            ...
            children: [
              ...
              textFeld(
                ...
                maxLines: 1,
                controller: buyerusernameController,
              ),
              TextField(
              ...
              SizedBox(height: 10,),
              TextField(
                controller: buyercpasswordController,
                style: const TextStyle(color: Colors.black, fontSize: 14.5),
                obscureText: isPasswordVisible ? false : true,
                decoration: InputDecoration(
                  fillColor: Color(0xffbce8ca),
              ...
              TextFormField(
                ...
                onChanged: (value){
                  setState(() {
                    buyerphoneController.text = value;
                  });
                },
                decoration: InputDecoration(
                  ...
                  suffixIcon: buyerphoneController.text.length > 8 && buyerphoneController.text.length<10? Container(
                    height: 30,
                    width: 30,
  ...
  void storeDatasendMessage() async {
    ...
    String phoneNumber = buyerphoneController.text.trim();
    ap.signInWithPhone(context, "+${selectedCountry.phoneCode}$phoneNumber");
    UserModel userModel = UserModel(
      username: buyerusernameController.text.trim(),
      password: buyerpasswordController.text.trim(),
      cpassword: buyercpasswordController.text.trim(),
