...
class SignUpFarmer extends StatefulWidget {
  SignUpFarmer({Key? key}) : super(key: key);

  @override
  State<SignUpFarmer> createState() => _SignUpState();
}

class _SignUpState extends State<SignUpFarmer> {
  ...
  TextEditingController farmercpasswordController = TextEditingController();
  TextEditingController farmeremailController = TextEditingController();
  TextEditingController farmeraddressController = TextEditingController();
  bool isPasswordVisible = false;

  @override
  void dispose() {
    super.dispose();
    farmerusernameController.dispose();
    farmerpasswordController.dispose();
    farmercpasswordController.dispose();
    farmeremailController.dispose();
    farmeraddressController.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    farmerphoneController.selection = TextSelection.fromPosition(
      TextPosition(offset: farmerphoneController.text.length)
    );
    final isLoading =
        ...
        SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10,),
              TextField(
                controller: farmercpasswordController,
                style: const TextStyle(color: Colors.black, fontSize: 14.5),
                obscureText: isPasswordVisible ? false : true,
                decoration: InputDecoration(
                  fillColor: Color(0xffbce8ca),
              ...
              TextFormField(
                ...
                onChanged: (value){
                  setState(() {
                    farmerphoneController.text = value;
                  });
                },
                decoration: InputDecoration(
                  ...
                  suffixIcon: farmerphoneController.text.length > 8 && farmerphoneController.text.length<10? Container(
                    height: 30,
                    width: 30,
  ...
  void storeDatasendMessage() async {
    ...
    String phoneNumber = farmerphoneController.text.trim();
    ap.signInWithPhone(context, "+${selectedCountry.phoneCode}$phoneNumber");
    UserModel userModel = UserModel(
      username: farmerusernameController.text.trim(),
      password: farmerpasswordController.text.trim(),
      cpassword: farmercpasswordController.text.trim(),
      email: farmeremailController.text.trim(),
      address: farmeraddressController.text.trim(),
